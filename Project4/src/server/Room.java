...
public class Room implements AutoCloseable {
    ...
    protected void muteOption(ServerThread client, String user) 
    {
		...
		while (iter.hasNext()) 
		{
			...
			{
				n.send(client.getClientName(),
						" <b style=color:red><b> Has muted you. They cannot see your messages.</b></b>");
			}
		}
	}
    ...
    protected void unmuteOption(ServerThread client, String user) 
    {
				...
				while (iter.hasNext()) 
				{
					...
					{
						n.send(client.getClientName(),
								" <b style=color:green><b> Has unmuted you. They can now see your messages.</b></b>");
			}
		}
	}
